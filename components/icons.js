// Minimal stroke-based SVG icon set (Feather-style).
// No emojis anywhere on the store — these replace them.
// Safe for both Server and Client Components (plain SVG, no hooks).
